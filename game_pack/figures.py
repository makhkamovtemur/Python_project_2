...
class Figure:#"(pygame.sprite.Sprite):
    ...
    def __init__(self, filename, r, c, side, board):
        ...
        self.image_path = os.path.join('static', 'sprites', filename)
        self.row = r
        self.col = c
        self.side = side
        self.board = board
...
class King(Figure):
    ...
    def __init__(self, r, c, side, board):
        super().__init__(side + 'King.png', r, c, side, board)
...
class Queen(Figure):
    ...
    def __init__(self, r, c, side, board):
        super().__init__(side + 'Queen.png', r, c, side, board)
...
class Rook(Figure):
    ...
    def __init__(self, r, c, side, board):
        super().__init__(side + 'Rook.png', r, c, side, board)
...
class Bishop(Figure):
    ...
    def __init__(self, r, c, side, board):
        super().__init__(side + 'Bishop.png', r, c, side, board)
...
class Knight(Figure):
    ...
    def __init__(self, r, c, side, board):
        super().__init__(side + 'Knight.png', r, c, side, board)
...
class Pawn(Figure):
    ...
    def __init__(self, r, c, side, board):
        super().__init__(side + 'Pawn.png', r, c, side, board)
